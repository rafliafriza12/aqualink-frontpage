...
const FeatureSection: React.FC = () => {
  return (
    <>
      <div
        id="superiority"
        className=" w-full min-h-screen hidden lg:block bg-[#1E2272] relative z-0 overflow-hidden"
      >
        <div className="hidden md:block w-[150vw] h-[80vw] rounded-full bg-[#4952FE] blur-[300px] absolute z-[-4] -bottom-[40%] -left-[70%]"></div>
        <FlickeringGrid
      ...
      <div
        id="superiority"
        className=" w-full h-screen block lg:hidden bg-gradient-to-bl from-[#1f2375] to-[#4952FE] relative z-0 overflow-hidden"
      >
        <FlickeringGrid
